#ifndef VISMinimumCostConstantFlowNC_HPP
#define VISMinimumCostConstantFlowNC_HPP
...
class VisMinimumCostConstantFlowNC : public QDialog
{
    Q_OBJECT

public:
    VisMinimumCostConstantFlowNC(QList<int> ids, QWidget* parent = 0);
...
#endif // VISMinimumCostConstantFlowNC_HPP
